...
// pending, accepted, rejected
  ...
  @override
  String toString() {
    return 'FriendRequest(id: $id, senderId: $senderId, senderName: $senderName, receiverId: $receiverId, status: $status, createdAt: $createdAt, respondedAt: $respondedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, senderId, senderName,
      receiverId, status, createdAt, respondedAt);
...
abstract class _FriendRequest implements FriendRequest {
  const factory _FriendRequest(
      ...
      final DateTime? respondedAt}) = _$FriendRequestImpl;
